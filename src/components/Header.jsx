...
export function Header() {
    ...
    return(
    <>
        <Paper elevation={3} square sx={{bgcolor: 'black', position: "absolute", top: 0, left:0, right: 0, minHeight:300, width: "100vw", height: "40vh" , alignContent: "center", justifyContent: "center", alignItems: "center", alignSelf: "center", justifyItems: "center"}}>
